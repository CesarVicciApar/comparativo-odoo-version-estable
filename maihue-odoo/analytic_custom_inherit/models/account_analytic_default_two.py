...
class AccountAnalyticDefaultTwo(models.Model):
    _name = "account.analytic.default.two"
    _description = "Analytic Distribution 2"
    ...
    analytic_id = fields.Many2one('account.analytic.account.two', string='Analytic Account')
    analytic_tag_ids = fields.Many2many('account.analytic.tag.two', string='Analytic Tags')
    ...
    def account_get(self, product_id=None, partner_id=None, account_id=None, user_id=None, date=None, company_id=None):
        ...
        best_index = -1
        res = self.env['account.analytic.default.two']
