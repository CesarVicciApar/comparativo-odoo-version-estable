...
class AccountAnalyticDefaultFour(models.Model):
    _name = "account.analytic.default.four"
    _description = "Analytic Distribution 4"
    ...
    analytic_id = fields.Many2one('account.analytic.account.four', string='Analytic Account')
    analytic_tag_ids = fields.Many2many('account.analytic.tag.four', string='Analytic Tags')
    ...
    def account_get(self, product_id=None, partner_id=None, account_id=None, user_id=None, date=None, company_id=None):
        ...
        best_index = -1
        res = self.env['account.analytic.default.four']
